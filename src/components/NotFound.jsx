...
const NotFound = () =>{
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-(--bg) text-center px-4">
            <div className="text-(--accent) font-extrabold text-9xl mb-4">
                404
            </div>
            ...
            <button 
                onClick={() => navigate('/')}
                className="px-6 py-3 bg-(--bg-secondary) hover:bg-(--code-bg) text-(--text-h) border border-(--border) rounded-xl font-medium transition-all shadow-sm flex items-center gap-2"
            >
